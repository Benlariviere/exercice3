...
function theme_4w4_scripts() {
	...
	wp_enqueue_style( 'theme-4w4-google-fonts', 'https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@300;600&display=swap', false ); 
	...
	wp_register_script('theme-4w4-carrousel_2', get_template_directory_uri() . '/js/carrousel_2.js', array(), _S_VERSION, true );
	...
	if ( is_front_page()){
		...
		wp_enqueue_script( 'theme-4w4-carrousel_2' );
	}
